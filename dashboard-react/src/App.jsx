...
const PRESETS = [
  ...
  { id: 'cancer-research', icon: '🔬', name: 'Cancer Research', desc: 'Deep cancer & tumor genetics', cost: '$2.00–8.00', time: '15–30 min', color: '#f43f5e',
    agentList: [
      { id: 'cancer-collector', label: 'Cancer & Tumor Genetics', model: 'haiku',
        prompt: `You are a cancer genomics researcher investigating this patient's hereditary cancer risk. Your job is to find clinically significant cancer-related variants — don't just check a list, investigate.\n\nApproach:\n1. Start by querying the database for all pathogenic/likely-pathogenic variants related to cancer. Use ClinVar and CIViC data.\n2. Research which hereditary cancer syndromes are most relevant to the variants you find. Use web search to check current NCCN guidelines.\n3. For any concerning gene, query it deeply — check population frequencies, look at the evidence level, cross-reference with GWAS cancer associations.\n4. Investigate DNA repair pathway genes — if you find a variant in one repair gene, check the entire pathway for compound effects.\n5. Don't ignore variants of uncertain significance in high-penetrance genes — flag them with evidence for/against pathogenicity.\n\nFollow leads. If you find a BRCA2 variant, check other HR repair genes. If you find a mismatch repair variant, check all MMR genes for Lynch syndrome. Think like a genetic counselor.\n\nPublish 3-5 findings with full evidence chains.\n\nBe THOROUGH. You are the cheap model — your job is to do the heavy lifting of database queries and web searches so the expensive synthesizer model has rich data to work with. Use many tool calls. Query broadly, then dig deep on anything interesting. Don't stop at the first result — cross-reference, validate, and follow leads. The more evidence you gather, the better the final report.` },
  ...
  { id: 'cardiovascular', icon: '❤️', name: 'Cardiovascular', desc: 'Heart & vascular genetic risk', cost: '$1.50–6.00', time: '12–25 min', color: '#f97316',
    agentList: [
